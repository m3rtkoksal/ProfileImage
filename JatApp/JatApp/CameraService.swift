...
public class CameraService {
    ...
    public func configure() {
        ...
        YES BUT doing it async is blocking lower ios models turning on the camera so I did it on the main queue
         */
    ...
    public func checkForPermissions() {
        ...
        default:
            ...
            DispatchQueue.main.async {
                self.alertError = AlertError(title: "Alert",
                                             message: "Please give permission for camera",
        ...
        if self.setupResult != .configurationFailed {
            ...
            sessionQueue.async {
                ...
                let photoCaptureProcessor = PhotoCaptureProcessor(with: photoSettings, willCapturePhotoAnimation: { [weak self] in
                    ...
                    if let data = photoCaptureProcessor.photoData, let image = UIImage(data: data) {
                        completion(image)
                        print("Passing photo as UIImage")
                    } else {
                        completion(nil)
                        print("No photo data")
                    }
